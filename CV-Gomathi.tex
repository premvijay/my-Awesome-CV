...
\begin{cventries}
\cventry
    {Enhancing Authentication Protocol in Mobile Cloud Computing} % Project name
    {Master's Thesis Project} % Organization
    {NIT Trichy} % Location
...
\cventry
    {Identity-based Healthcare System} % Project name
    {Bachelor's Final Project} % Organization
    {Sona College of Technology} % Location
    {September 2016 - March 2017} % Date(s)
    {
      \begin{cvitems}
